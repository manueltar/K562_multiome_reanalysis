...
do
    ...
    Rscript_DA_function=$(echo "$Rscripts_path""488_Multiome_DA_per_cluster_Diffs_K562_v2_only_peaks_in_GRN_CUX1_and_RUNX1.R")


    GRN_peaks=$(echo "/group/soranzo/manuel.tardaguila/2025_K562_multiome_reanalysis/Downstream_analysis/simba/CUX1_RUNX1_peaks_and_genes.tsv")
